...
export PYTHONPATH="$PWD/../util/mpi4py-3.0.0/install_location_mpi4py/lib/python2.7/site-packages:$PWD/../install_location_pyranda/lib/python2.7/site-packages:$PWD/../kernel_stats"
